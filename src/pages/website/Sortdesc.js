...
const SortDesc = ({handleSetTitle,Categories}) => {
    useEffect(()=>{
        handleSetTitle('Shop')
    ...
    useEffect(() => {
        const listProduct = async () => {
          try {
            const { data: product } = await ProductApi.getSort2();
            setProducts(product);
          } catch (error) {
            console.log(error);
          }
    ...
    return (
        ...
        <div className="p-20 grid grid-cols-4" >
            ...
            <div className="col-span-3 px-4">
                <div className="mb-24">
                    <div className="float-left text-lg text-gray-700 font-medium py-4">Price product's high to low</div>
